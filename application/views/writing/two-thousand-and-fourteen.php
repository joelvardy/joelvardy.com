<div class="post">
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Birthday in Amsterdam</h4>
				<p>Talked about, but not organised. At the last minute I booked a weekend trip to Amsterdam for my 21<sup>st</sup> birthday.</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Scotland Skiing and Walking</h4>
				<p>I spent a week in the Scottish Highlands with my mother and sisters, we skied on some lovely snow, and walked seeing some lovely views.</p>
			</div>
		</div>
	</div>

	<p>On the <strong>16<sup>th</sup> March</strong> I set out into the peak district with my brother Steve, and Ed to make a mountain bike film, we learnt a lot about continuity, and after looking through all of the footage, I managed to edit it all together and get it uploaded before going to bed.</p>

	<div class="video aspect-16-9">
		<iframe src="//player.vimeo.com/video/89204946?title=0&amp;byline=0&amp;portrait=0" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Biking in Wales</h4>
				<p>I was once again enjoying mountain biking, spending a weekend in Wales; Saturday at Bike Park Wales and Sunday at the Forest of Dean.</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Barcelona</h4>
				<p>Me and my brother joined my mum in Barcelona for her Birthday, we visited several of Gaud&iacute;s works, and enjoyed the Formula 1 practice sessions.</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Back in Wales</h4>
				<p>More biking, this time with a spot of tenting thrown in too!</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Pan Germanic - Belgian Trip</h4>
				<p>Traveling from <strong>Berlin</strong> &#8674; <strong>D&uuml;sseldorf</strong> &#8674; <strong>Cologne</strong> &#8674; <strong>Belgium</strong> to watch the Formula 1 race at Spa.</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>London</h4>
				<p>I arrived, and watched Lewis Hamilton win the Formula 1 World Championship, before seeing <strong>Linkin Park</strong> live at The 02.</p>
			</div>
		</div>
	</div>
	...
	<div class="photo full-width event">
		...
		<div class="inner">
			...
			<div class="details">
				<h4>Snow on Boxing Day</h4>
				<p>In Sheffield we actually enjoyed some nice snow just after Christmas, and the cold weather meant the snow hung around for several days.</p>
			</div>
		</div>
	</div>

	<p>I've spent a lot of this summer taking photos, I've seen an improvement in the quality of the photos I've taken but I still have a lot to learn. I'm hoping to progress even more in 2015 and hopefully develop some more powerful timelapse techniques.</p>
